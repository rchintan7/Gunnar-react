...
// import logo from "../../../public/Content/images/info.png";
// import headerImage from '../../../public/Content/images/BootstrapHeaderComposed.jpg';
// import hamburger from "../../../public/Content/images/Hamburger.png";
...
const Frame = (props) => {
  ...
  const getCss = (spriteType, dayNumber) =>
    `transparent url('/assets/Content/images/BootstrapHeaderComposed.jpg') 0 ${
      -81 * dayNumber
    }px`;
  const [todaysHeaderCss, setTodaysHeaderCss] = useState(
    getCss("Header", dayNumber)
  );
  const [todaysFooterCss, setTodaysFooterCss] = useState(
    getCss("Footer", dayNumber)
  );
  ...
  return (
    <div>
      <header
        ...
        style={{ background: todaysHeaderCss, height: "81px", margin: "0" }}
      >
        <div className="container">
          <a className="navbar-brand pb-5 mb-3" href="/">
            <ReactSvgIcon
              text={"ReactHomepage"}
              icon="/assets/Content/images/info.png"
              iconClass={"logo"}
            />
          </a>
          <button
          ...
          >
            <span className="navbar-toggler-icon">
              <img
                src="/assets/Content/images/Hamburger.png"
                alt="Hamburger Icon"
              />
            </span>
          </button>
          <div className="collapse navbar-collapse navbar-nav-container">
            ...
            <ul className="navbar-nav navbar-nav-right spriteTabs">
              <li className="nav-item">
                <a
                  href="https://www.google.com/maps/place/Statue+of+Liberty/@40.688969,-113.0657959,4z/data=!4m10!1m2!2m1!1sstaue+of+liberty!3m6!1s0x89c25090129c363d:0x40c6a5770d25022b!8m2!3d40.6892494!4d-74.0445004!15sChFzdGF0dWUgb2YgbGliZXJ0eVoTIhFzdGF0dWUgb2YgbGliZXJ0eZIBE2hpc3RvcmljYWxfbGFuZG1hcmvgAQA!16zL20vMDcycDg?entry=ttu"
                  target="_blank"
              ...
              <li className="nav-item">
                <NavLink to="/user" className="nav-link no-underline">
                  <span></span>&nbsp;<i className="fas fa-user"></i>
                  <span></span>
                </NavLink>
              </li>
            </ul>
      ...
      <div className={`sidebar ${sidebarOpen ? "open" : ""}`} ref={sidebarRef}>
        <div className="sidebar-header">
          <a
            ...
            className="nav-link no-underline"
          >
            <span></span>&nbsp;&nbsp;<i className="fas fa-map-marker-alt"></i>
            <span></span>
          </a>
          <NavLink to="/user" className="nav-link" onClick={closeSidebar}>
        ...
        <div className="nav-list">
          <ul className="navbar-nav">
            <li ref={menuRefs.homeLi} className="nav-item">
              <NavLink exact to="/" className="nav-link" onClick={closeSidebar}>
                Home
              </NavLink>
            </li>
            <li ref={menuRefs.albumsLi} className="nav-item">
              <NavLink to="/albums" className="nav-link" onClick={closeSidebar}>
                Album
              </NavLink>
            </li>
          </ul>
      ...
      <footer
        ...
        style={{ background: todaysFooterCss, height: "81px", margin: "0" }}
      >
        <div className="text-center p-3">© 2024 - React Homepage Ltd.</div>
      </footer>
    </div>
  );
};
